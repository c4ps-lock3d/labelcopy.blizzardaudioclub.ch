                    ...
                    <div class="space-y-6 border-gray-700 text-gray-900 dark:text-gray-100 pb-6">
                        <h3 class="text-lg font-medium flex items-center mb-4">
                            ...
                            >
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 gap-8 !mt-1 items-stretch">
                                    <div
                                    ...
                                    >
                                        ...
                                        <!-- Ligne principale en 2 colonnes -->
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <!-- Colonne 1 : Titre + ISRC -->
                                            <div class="flex flex-col gap-2">
                                                <InputLabel :for="`track-title-${index}`" value="Titre" class="text-sm" />
                                                <TextInput
                                                ...
                                                <div v-if="props.auth.user.name === 'lynxadmin'">
                                                    <InputLabel :for="`track-isrc-${index}`" value="ISRC" class="text-sm" />
                                                    <TextInput
                                                        :id="`track-isrc-${index}`"
                                                        type="text"
                                                        v-model="track.IRSC"
                                            ...
                                            <!-- Colonne 2 : Clip, Single, Date, Description -->
                                            <div class="flex flex-col gap-2">
                                                <div class="flex items-center space-x-2">
                                                    <input
                                                        ...
                                                        :disabled="isDisabled"
                                                    />
                                                    <InputLabel value="Ce titre a un clip" class="text-sm" />
                                                </div>
                                                <div class="flex items-center space-x-2">
                                                    <input
                                                        type="checkbox"
                                                        ...
                                                        :disabled="isDisabled"
                                                    />
                                                    <InputLabel value="Ce titre est un single" class="text-sm" />
                                                </div>
                                            </div>
                                            <!-- Colonne 2 : Clip, Single, Date, Description -->
                                            <div class="flex flex-col gap-2">
                                                <div v-if="track.isSingle" class="flex flex-col gap-2">
                                                    <InputLabel :for="`track-release-date-${index}`" value="Date de sortie du single" class="text-sm" />
                                                    <TextInput
                                                        :id="`track-release-date-${index}`"
                                                        type="date"
                                                        v-model="track.release_date_single"
                                                        class="transition duration-150 ease-in-out"
                                                        :disabled="isDisabled"
                                                    />
                                                    <InputLabel :for="`track-release-desc-${index}`" value="Description du single" class="text-sm" />
                                                    <TextArea   
                                                        :id="`track-release-desc-${index}`"
                                        ...
                                        <!-- Ligne 2 : clé de répartition sur toute la largeur -->
                                        <hr class="my-2 border-gray-300 dark:border-gray-600" />
                                        <span class="font-semibold text-indigo-700 dark:text-indigo-300">Clé de répartition précise des membres</span>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-7 gap-1">
                                                ...
                                                >
                                                    <InputLabel
                                                        ...
                                                        :value="participation.firstname && participation.lastname ? participation.firstname + ' ' + participation.lastname : 'Membre'"
                                                    />
